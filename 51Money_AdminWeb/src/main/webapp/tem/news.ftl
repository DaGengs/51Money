    ...
    <div >
      <div class="mod-borrow">
        <div style="font-size: 35px;font-weight: bold">
          <h1 align="center">${news.title?default("")}</h1>
        </div>
        <div class="bd">
          <div class="des"><span class="fn-left">${news.lastTime?default("")}</span><a href="${news.sourceUrl?default("")}" class="fn-right">${news.sourceName?default("")}&gt;&gt;</a></div>
          <div class="borrow-list">
              ${news.contentHtml?default("")}
          </div>
            <div>
...
<div class="partners wrap clearfix mrb30">
  <div class="partners-inner ui-tab">
    <div class="hd">
      <div class="ui-tab-nav" style="margin-left: 450px"> <i class="icon icon-cur" style="left: 491px;"></i>
        <ul>
