        ...
        , cols: [[ //表头
            ...
            , {
                field: 'idCardImg_pre', align: 'center', title: '身份证正面', templet: function (obj) {
                    return "<img src='" + obj.idCardImg_pre + "' style='cursor: pointer;' title='点击图片放大' onclick='big(this)' width='50px' height='50px' alt='未上传'/>"
                }
            }
            , {
                field: 'idCardImg_aft', align: 'center', title: '身份证反面', templet: function (obj) {
                    return "<img src='" + obj.idCardImg_aft + "' style='cursor: pointer;' title='点击图片放大' onclick='big(this)' width='50px' height='50px' alt='未上传'/>"
                }
            }
            , {
